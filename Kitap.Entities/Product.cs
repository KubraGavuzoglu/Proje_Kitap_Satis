...
namespace Kitap.Entities
{
    public class Product : IEntity
    {
        ...
        [Display(Name = "Eklenme Tarihi"), ScaffoldColumn(false)] // ScaffoldColumn(false)  CreateDate propertysinin view oluşturulurken ekranda divinin oluşmamasını sağlar
